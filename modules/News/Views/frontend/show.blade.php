...
<div class="max-w-4xl mx-auto px-4 overflow-hidden">
    ...
    <div class="mt-6">
        <a href="{{ route('news.index') }}" class="text-blue-600 hover:underline">← Назад к списку</a>
    </div>
</div>
@endsection
...
@push('styles')
<style>
.news-content{overflow-wrap:break-word;word-wrap:break-word;word-break:break-word}
...
.news-content table{width:100%;overflow-x:auto;display:block}
